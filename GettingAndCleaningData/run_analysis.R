...
# Performing cleaning and generating the data file
...
run.analysis <- function(dir) {
  ...
  cat(paste("Done with the cleaning it is at ",dir,sep = "") )
}

# Run the analysis.
run.analysis("~/GettingAndCleaningData/dataset")
