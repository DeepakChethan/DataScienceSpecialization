...
To run the script, source `run_analysis.R`. After it completes you will find your data inside cleaned_data.txt 
...
The resulting clean dataset is in this repository at: `dataset/cleaned_data.txt`. It contains one row for each subject/activity pair and columns for subject, activity, and each feature that was a mean or standard deviation from the original dataset.
